...
import { formatTelefono, formatDate } from "@/lib/utils"
...
export default async function JuzgadoDetallePage({
  params,
}: {
  params: { id: string }
}) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button asChild>
          <Link href={`/juzgados/${params.id}/editar`}>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p>{formatTelefono(juzgado.telefono)}</p>
              </div>
              <div>
